...
function warn$1(message) {
    var _a;
    warn(message, (_a = vue_composition_api_getCurrentInstance()) === null || _a === void 0 ? void 0 : _a.proxy);
}
...
function recordEffectScope(effect, scope) {
    ...
    var vm = (_a = vue_composition_api_getCurrentInstance()) === null || _a === void 0 ? void 0 : _a.proxy;
...
function getCurrentScopeVM() {
    var _a, _b;
    return ((_a = getCurrentScope()) === null || _a === void 0 ? void 0 : _a.vm) || ((_b = vue_composition_api_getCurrentInstance()) === null || _b === void 0 ? void 0 : _b.proxy);
}
/**
 * @internal
 **/
...
function vue_composition_api_getCurrentInstance() {
...
function getCurrentInstanceForFn(hook, target) {
    target = target || vue_composition_api_getCurrentInstance();
    if (false) {}
    return target;
}
...
function ref(raw) {
    var _a;
    if (vue_composition_api_isRef(raw)) {
        return raw;
    }
...
function vue_composition_api_isRef(value) {
    return value instanceof RefImpl;
}
function vue_composition_api_unref(ref) {
    return vue_composition_api_isRef(ref) ? ref.value : ref;
}
function vue_composition_api_toRefs(obj) {
    if (false) {}
    if (!isPlainObject(obj))
        return obj;
    var ret = {};
    for (var key in obj) {
        ret[key] = vue_composition_api_toRef(obj, key);
    }
    return ret;
}
...
function vue_composition_api_toRef(object, key) {
    if (!(key in object))
        set$1(object, key, undefined);
    var v = object[key];
    if (vue_composition_api_isRef(v))
        return v;
    return createRef({
...
function triggerRef(value) {
    if (!vue_composition_api_isRef(value))
        return;
...
function proxyRefs(objectWithRefs) {
    var _a, e_1, _b;
    if (vue_composition_api_isReactive(objectWithRefs)) {
    ...
    var _loop_1 = function (key) {
        proxy(value, key, {
            get: function () {
                if (vue_composition_api_isRef(value[RefKey][key])) {
            ...
            set: function (v) {
                if (vue_composition_api_isRef(value[RefKey][key])) {
                    return (value[RefKey][key].value = vue_composition_api_unref(v));
                }
                value[RefKey][key] = vue_composition_api_unref(v);
            },
        });
    };
    try {
...
function vue_composition_api_isReactive(obj) {
    var _a;
    return Boolean(obj &&
        hasOwn(obj, '__ob__') &&
        typeof obj.__ob__ === 'object' &&
...
function setupAccessControl(target) {
    if (!isPlainObject(target) ||
        isRaw(target) ||
        isArray(target) ||
        vue_composition_api_isRef(target) ||
...
function defineAccessControl(target, key, val) {
    ...
    proxy(target, key, {
        get: function getterHandler() {
            ...
            if (key !== RefKey && vue_composition_api_isRef(value)) {
                return value.value;
            }
            else {
                return value;
        ...
        set: function setterHandler(newVal) {
            ...
            if (key !== RefKey && vue_composition_api_isRef(val) && !vue_composition_api_isRef(newVal)) {
                val.value = newVal;
            }
            else if (setter) {
 ...
 */
function vue_composition_api_markRaw(obj) {
...
function vue_composition_api_toRaw(observed) {
    var _a;
...
function shallowReadonly(obj) {
    ...
    if (!(isPlainObject(obj) || isArray(obj)) ||
        (!Object.isExtensible(obj) && !vue_composition_api_isRef(obj))) {
        return obj;
    }
    var readonlyObj = vue_composition_api_isRef(obj)
        ? new RefImpl({})
        : vue_composition_api_isReactive(obj)
            ? observe({})
            : {};
    var source = reactive({});
    ...
    var _loop_1 = function (key) {
        ...
        var property = Object.getOwnPropertyDescriptor(obj, key);
        if (property) {
            if (property.configurable === false && !vue_composition_api_isRef(obj)) {
                return "continue";
            }
            getter = property.get;
        }
...
function wrapHookCall(instance, fn) {
    return function () {
        ...
        var prev = vue_composition_api_getCurrentInstance();
...
function createWatcher(vm, source, cb, options) {
    ...
    var getter;
    if (vue_composition_api_isRef(source)) {
        getter = function () { return source.value; };
    }
    else if (vue_composition_api_isReactive(source)) {
        ...
        getter = function () {
            return source.map(function (s) {
                if (vue_composition_api_isRef(s)) {
                    return s.value;
                }
                else if (vue_composition_api_isReactive(s)) {
                    return traverse(s);
                }
    ...
    if (vue_composition_api_isReactive(watcher.value) && ((_a = watcher.value.__ob__) === null || _a === void 0 ? void 0 : _a.dep) && deep) {
...
// implementation
function vue_composition_api_watch(source, cb, options) {
    var callback = null;
    if (isFunction(cb)) {
        // source watch
        callback = cb;
...
function vue_composition_api_inject(key, defaultValue, treatDefaultAsFactory) {
    var _a;
...
var useCssModule = function (name) {
    ...
    var instance = vue_composition_api_getCurrentInstance();
    if (!instance) {
        ( false) && 0;
        return EMPTY_OBJ;
    }
...
var createElement = function createElement() {
    ...
    var instance = (this === null || this === void 0 ? void 0 : this.proxy) || ((_a = vue_composition_api_getCurrentInstance()) === null || _a === void 0 ? void 0 : _a.proxy);
    if (!instance) {
        ( false) &&
            0;
...
function getContext() {
    var i = vue_composition_api_getCurrentInstance();
    if (false) {}
    return i.setupContext;
}

function vue_composition_api_set(vm, key, value) {
...
function asVmProperty(vm, propName, propValue) {
    ...
    if (!(propName in vm) && !(props && hasOwn(props, propName))) {
        if (vue_composition_api_isRef(propValue)) {
            proxy(vm, propName, {
            ...
            proxy(vm, propName, {
                get: function () {
                    if (vue_composition_api_isReactive(propValue)) {
...
function updateTemplateRef(vm) {
    ...
    for (var index = 0; index < oldRefKeys.length; index++) {
        ...
        if (!refs[key] && setupValue && vue_composition_api_isRef(setupValue)) {
...
function activateCurrentInstance(instance, fn, onError) {
    var preVm = vue_composition_api_getCurrentInstance();
    setCurrentInstance(instance);
    try {
        return fn(instance);
    }
...
function mixin(Vue) {
    ...
    function initSetup(vm, props) {
        ...
        if (isFunction(binding)) {
            ...
            if (vue_composition_api_isReactive(binding)) {
                binding = vue_composition_api_toRefs(binding);
            }
            vmStateManager.set(vm, 'rawBindings', binding);
            var bindingObj_1 = binding;
            Object.keys(bindingObj_1).forEach(function (name) {
                var bindingValue = bindingObj_1[name];
                if (!vue_composition_api_isRef(bindingValue)) {
                    if (!vue_composition_api_isReactive(bindingValue)) {
    ...
    function customReactive(target, seen) {
        ...
        if (!isPlainObject(target) ||
            vue_composition_api_isRef(target) ||
            vue_composition_api_isReactive(target) ||
            isRaw(target))
            return;
        var Vue = getVueConstructor();
        // @ts-expect-error https://github.com/vuejs/vue/pull/12132
    ...
    function hasReactiveArrayChild(target, visited) {
        ...
        if (isArray(target) && vue_composition_api_isReactive(target)) {
            visited.set(target, true);
            return true;
        }
        if (!isPlainObject(target) || isRaw(target) || vue_composition_api_isRef(target)) {
            return false;
        }
...
function mergeData(from, to) {
    ...
    for (var i = 0; i < keys.length; i++) {
        ...
        if (!hasOwn(to, key)) {
            ...
            isPlainObject(toVal) &&
            !vue_composition_api_isRef(toVal) &&
            isPlainObject(fromVal) &&
            !vue_composition_api_isRef(fromVal)) {
...
function lib_install(_vue) {
  _vue = _vue || external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject
  if (_vue && !_vue['__composition_api_installed__'])
    external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.use(Plugin)
}

lib_install(external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject)

var lib_isVue2 = true
var isVue3 = false
var Vue2 = external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject
var lib_version = external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.version
...
;// CONCATENATED MODULE: ./node_modules/pinia/dist/pinia.esm-browser.js
/*!
  * pinia v2.0.14
...
function pinia_esm_browser_isPlainObject(
...
function createPinia() {
    ...
    let toBeInstalled = [];
    const pinia = vue_composition_api_markRaw({
        install(app) {
...
function patchObject(newState, oldState) {
    ...
    for (const key in oldState) {
        ...
        if (pinia_esm_browser_isPlainObject(targetValue) &&
            pinia_esm_browser_isPlainObject(subPatch) &&
            !isRef(subPatch) &&
            !isReactive(subPatch)) {
...
function addSubscription(subscriptions, callback, detached, onCleanup = noop) {
    ...
    if (!detached && vue_composition_api_getCurrentInstance()) {
...
function mergeReactiveObjects(target, patchToApply) {
    ...
    for (const key in patchToApply) {
        ...
        if (pinia_esm_browser_isPlainObject(targetValue) &&
            ...
            !vue_composition_api_isRef(subPatch) &&
            !vue_composition_api_isReactive(subPatch)) {
...
function shouldHydrate(obj) {
    return lib_isVue2
        ...
        : !pinia_esm_browser_isPlainObject(obj) || !obj.hasOwnProperty(skipHydrateSymbol);
}
const { assign: pinia_esm_browser_assign } = Object;
function isComputed(o) {
    return !!(vue_composition_api_isRef(o) && o.effect);
}
function createOptionsStore(id, options, pinia, hot) {
    ...
    function setup() {
        ...
        const localState =  false
            ? // use ref() to unwrap refs inside state TODO: check if this is still necessary
                0
            : vue_composition_api_toRefs(pinia.state.value[id]);
        return pinia_esm_browser_assign(localState, actions, Object.keys(getters || {}).reduce((computedGetters, name) => {
            computedGetters[name] = vue_composition_api_markRaw(computed(() => {
                setActivePinia(pinia);
    ...
    store.$reset = function $reset() {
        ...
        this.$patch(($state) => {
            pinia_esm_browser_assign($state, newState);
        });
    };
    return store;
}
function createSetupStore($id, setup, options = {}, pinia, hot, isOptionsStore) {
    let scope;
    const optionsForPlugin = pinia_esm_browser_assign({ actions: {} }, options);
    /* istanbul ignore if */
    ...
    let subscriptions = vue_composition_api_markRaw([]);
    let actionSubscriptions = vue_composition_api_markRaw([]);
    let debuggerEvents;
    const initialState = pinia.state.value[$id];
    ...
    const _hmrPayload = /*#__PURE__*/ vue_composition_api_markRaw({
        actions: {},
        getters: {},
        state: [],
        hotState,
    ...
    const partialStore = {
        ...
        $subscribe(callback, options = {}) {
            ...
            const stopWatcher = scope.run(() => vue_composition_api_watch(() => pinia.state.value[$id], (state) => {
            ...
            }, pinia_esm_browser_assign({}, $subscribeOptions, options)));
            return removeSubscription;
        },
        $dispose,
    };
    ...
    const store = reactive(pinia_esm_browser_assign( false
    ...
    for (const key in setupStore) {
        ...
        if ((vue_composition_api_isRef(prop) && !isComputed(prop)) || vue_composition_api_isReactive(prop)) {
            // mark it as a piece of state to be serialized
            if (false) {}
            else if (!isOptionsStore) {
                // in setup stores we must hydrate the state and sync pinia state tree with the refs the user just created
                if (initialState && shouldHydrate(prop)) {
                    if (vue_composition_api_isRef(prop)) {
    ...
    if (lib_isVue2) {
        ...
        pinia_esm_browser_assign(store, setupStore);
        // allows retrieving reactive objects with `storeToRefs()`. Must be called after assigning to the reactive object.
        // Make `storeToRefs()` work with `reactive()` #799
        pinia_esm_browser_assign(vue_composition_api_toRaw(store), setupStore);
    }
    ...
    Object.defineProperty(store, '$state', {
        ...
        set: (state) => {
            ...
            if (false) {}
            $patch(($state) => {
                pinia_esm_browser_assign($state, state);
            });
        },
    });
    ...
    pinia._p.forEach((extender) => {
        ...
        if (false) {}
            ...
            pinia_esm_browser_assign(store, scope.run(() => extender({
                store,
                app: pinia._a,
                pinia,
...
idOrOptions, setup, setupOptions) {
    ...
    function useStore(pinia, hot) {
        const currentInstance = vue_composition_api_getCurrentInstance();
        pinia =
            // in test mode, ignore the argument provided as we can always retrieve a
            // pinia instance with getActivePinia()
            ( false ? 0 : pinia) ||
                (currentInstance && vue_composition_api_inject(piniaSymbol));
        if (pinia)
            setActivePinia(pinia);
        if (false) {}
        pinia = activePinia;
...
;// CONCATENATED MODULE: ./src/packages/store/uistore.js
...
/* harmony default export */ var py_appvue_type_script_lang_js_ = ({
  name: 'py-app',
  components: {
    PyZero: zero
  },
  ...
  mounted: function mounted() {// function asyncdata(xiugai){
    ...
    //               {
    //                   tag:"v-text-field",
    //                   props:{name:"chao", age:25,value:"为爱加油"},
    //                   events:{"input":"input"},
    //                   solts:{
    //                       append:['我不知道'],
    //                       prepend:["爱是什么"]
    ...
    // setInterval(()=>{
    //   a++
    //   // opts.solts.default[0] = `输入点能量吧,${a}`
    //   this.opts = asyncdata( `输入点能量吧,${a}`)
    //   console.log(this.opts.solts.default[0])
    // },1000)
    // var a= 0
    // setInterval(()=>{
    //   a++
    //   this.opts = {tag:'div',props:{'class':'abc',ddx:{name:12}},solts:{default:[
    //     {tag:"p",solts:{default:['这是首行数据']}},
    //     {tag:"p",solts:{default:[`这是动态数据${a}`]}},
...
;// CONCATENATED MODULE: ./src/packages/py-app/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var packages_py_appvue_type_script_lang_js_ = (py_appvue_type_script_lang_js_); 
...
;// CONCATENATED MODULE: ./src/packages/py-app/index.vue
...
var component = normalizeComponent(
  packages_py_appvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var py_app = (component.exports);

/* vuetify-loader */
;

installComponents_default()(component, {VApp: VApp})
...
/******/ })()
;
//# sourceMappingURL=pywui.common.js.map